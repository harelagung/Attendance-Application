...
<div class="appBottomMenu" style="background-color: transparent; border:0cm">
    <div class="fab-container">
        <a href="/presensi/formulir" class="action-button large" id="fabButton">
...
<style>
    .appBottomMenu {
        ...
        padding: 20px;
        pointer-events: none;
        /* Penting: Ini akan membuat area navbar transparan terhadap klik */
    }

    .fab-container {
        position: relative;
        pointer-events: auto;
        /* Kembalikan pointer-events untuk container FAB */
    }
