...
<div class="appBottomMenu" style="background-color: transparent; border:0cm">
    <div class="fab-container">
        ...
        <div id="fabMenu" class="fab-menu">
            ...
            <a href="{{ route('absen.tampil') }}" class="fab-item">
                <ion-icon name="document-text" role="img" class="md hydrated" aria-label="document"></ion-icon>
            ...
            @endif
            {{-- <a href="{{ route('profil.tampil') }}" class="fab-item">
            ...
            <form action="{{ route('logout') }}" method="POST" style="margin: 0; display: inline;">
                ...
                <a href="#" onclick="this.closest('form').submit();return false;" class="fab-item">
                    <ion-icon name="power" role="img" class="md hydrated" aria-label="power"></ion-icon>
                    <span>Keluar</span>
                </a>
            </form>
        </div>
